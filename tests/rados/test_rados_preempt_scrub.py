...
def run(ceph_cluster, **kw):
    ...
    try:
        ...
        if not rados_object.bench_write(
            pool_name=pool_name, rados_write_duration=20, max_objs=4, num_threads=1
        ):
        ...
        set_parameter_value(mon_obj, rados_object, pool_name)
        ...
        get_paramter_value(mon_obj, rados_object, pool_name)
        # Wait tiem for starting the scheduled scrubbing
        time.sleep(240)
        ...
        unset_parameter_value(mon_obj, rados_object, pool_name)
        # log cluster health
...
def set_parameter_value(mon_object, rados_object, pool_name):
    """
    ...
    try:
        ...
        mon_object.set_config(section="osd", name="osd_scrub_max_interval", value=2000)
        ...
        mon_object.set_config(section="osd", name="debug_osd", value="10/10")
        time.sleep(10)
...
def unset_parameter_value(mon_object, rados_object, pool_name):
    """
...
def get_paramter_value(mon_object, rados_object, pool_name):
    """
